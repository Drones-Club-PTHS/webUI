export function VisitTable(tableElement) {
	// generate(stJson, extraLessonDates =[])
	tableElement.generate = generateVisitTableContent.bind(null, tableElement);
	return tableElement;
}

function generateVisitTableContent(tableElement, stJson, extraLessonDates = []) {
